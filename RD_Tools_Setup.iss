...
;#define ApplicationName 'RDTools'
;#define ApplicationVersion GetVersionNumberString('RDTools.exe')
#define MyAppName "RDTools"
;#define MyAppVersion "1.0.0.5"
#define MyAppVersion GetFileVersion("C:\Users\LucaBorgmann\OneDrive - Roedl Dynamics GmbH\Documents\GitHub\RD_Tools\RDTools.exe")
;#define MyAppVersion GetFileVersion(MyAppExe)
...
;Source: "{src}\schtasks.exe"; DestDir: "{tmp}"
